...
//		URL:     fmt.Sprintf("/offerings/users/%s", "2"),
//		URLParams: map[string]string{
//			"user_id": "2",
//		},
//	})
...
func (suite *AppTestSuite) TestCreateOffering() {
...
var patchOffering = &model.Offering{
	ID: newOffering.ID, // Unknown at this point
	UserID: "8b5bb736-6a1d-3378-8e71-ab45fe8beb84",
	WorkspaceID: "aad40cbb-4baf-3931-a5d2-6f98b414182a",
	Cancelled: true,
...
func (suite *AppTestSuite) TestPatchOffering() {
	t := suite.T()
	...
	rr2 := executeReq(t, &testRouteConfig{
		...
		URL:     fmt.Sprintf("/offerings/%s", newOffering.ID),
		URLParams: map[string]string{
			"id": newOffering.ID,
		},
	})
...
func (suite *AppTestSuite) TestDeleteOffering() {
	t := suite.T()
