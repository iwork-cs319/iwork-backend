...
func (p PostgresDBStore) CreateOffering(offering *model.Offering) error {
	sqlStatement :=
		`INSERT INTO offerings(id, user_id, workspace_id, start_time, end_time) VALUES ($1, $2, $3, $4, $5) RETURNING id`
	var id string
